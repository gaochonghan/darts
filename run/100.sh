...
srun python ./augment.py --name a100 --dataset cifar100 --batch_size 256 --epochs 2000 \
--checkpoint "/home/LAB/gaoch/darts/augments/a100/215685" --old_epoch 1437 --genotype \
"genotype = Genotype(normal=[[('sep_conv_5x5', 0), ('sep_conv_5x5', 1)], [('sep_conv_5x5', 2), ('sep_conv_5x5', 1)], [('dil_conv_5x5', 3), ('dil_conv_5x5', 2)], [('dil_conv_5x5', 4), ('dil_conv_5x5', 3)]], normal_concat=range(2, 6), reduce=[[('sep_conv_5x5', 1), ('sep_conv_5x5', 0)], [('dil_conv_5x5', 2), ('dil_conv_5x5', 1)], [('dil_conv_5x5', 3), ('dil_conv_5x5', 2)], [('dil_conv_5x5', 3), ('sep_conv_5x5', 1)]], reduce_concat=range(2, 6))"
...
# e2h1 "Genotype(normal=[[('skip_connect', 0), ('dil_conv_3x3', 1)], [('skip_connect', 0), ('skip_connect', 2)], [('dil_conv_3x3', 0), ('dil_conv_3x3', 3)], [('dil_conv_3x3', 1), ('sep_conv_3x3', 0)]], normal_concat=range(2, 6), reduce=[[('max_pool_3x3', 0), ('skip_connect', 1)], [('avg_pool_3x3', 0), ('skip_connect', 2)], [('avg_pool_3x3', 0), ('skip_connect', 2)], [('skip_connect', 2), ('avg_pool_3x3', 0)]], reduce_concat=range(2, 6))"